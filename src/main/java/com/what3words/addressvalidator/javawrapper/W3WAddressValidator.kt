...
interface W3WAddressValidator {
     ...
     **/
    fun search(near: String): Either<W3WAddressValidatorError, W3WAddressValidatorRootNode>
     ...
     * **/
    fun list(node: W3WAddressValidatorParentNode): Either<W3WAddressValidatorError, List<W3WAddressValidatorNode>>
